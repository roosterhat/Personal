...
public class MathView extends javax.swing.JFrame {
    ...
    private String defaultText = "Equation...";
    public MathView() {
        equation = new Equation();
        graph = new GraphPane(equation);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Graphing", jPanel1);
        ...
        jTabbedPane1.addTab("NoteBook", jPanel2);
    ...
    private void jTextField1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField1MouseClicked
        if(jTextField1.getText().equals(defaultText))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MathView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
