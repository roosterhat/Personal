...
public class Integration {
    ...
    public static void main(String[] args) {
        MathEquation e = new MathEquation("e^x/x^2");
        MathEquation e2 = new MathEquation("25/sqrt(pi(x^4))");
        int lower = 1;
        int upper = 4;
        int n = 10;
    ...
    public void integrate(MathEquation eq,double lower,double upper,int steps){
    ...
    public double deepIntegrate(MathEquation eq,double lower,double upper){
        try{
            double integral = 0;
            double width = 0.001;
    ...
    public double trapezoid(MathEquation eq,double lower,double upper,int steps){
        try{
    ...
    public double midpoint(MathEquation eq,double lower,double upper,int steps){
        try{
            double width = (upper-lower)/steps;
            double integral = 0;
            double x1 = lower;
    ...
    public double simpsons(MathEquation eq,double lower,double upper,int steps){
        try{
            double width = (upper-lower)/steps;
            double integral = 0;
            double x = lower;
    ...
    public double richardson(int steps, double lower,double upper){
        try{
            double diff = new MathEquation("2x^2*x^2/(2x^2-x^2)(y-z)/(2x)^2").fD(steps,upper,lower);
